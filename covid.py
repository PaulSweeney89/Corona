...
plt.plot(df["Datestr"], df["TotalConfirmedCovidCases"], marker='o', markersize=3, color="red")
plt.plot(df["Datestr"], df["ConfirmedCovidRecovered"], marker='o', markersize=3, color="green")
plt.xticks(df["Datestr"], rotation = '90')
plt.grid(which='major', axis='y', linestyle='dotted', alpha=0.8)
...
plt.bar(x=df["Datestr"], height=df["x"], color='b')
plt.xticks(df["Datestr"], rotation = '90')
plt.grid(which='major', axis='y', linestyle='dotted', alpha=0.8)
